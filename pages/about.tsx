    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center mb-64 pt-20">
        ...
        <main className="container">
          ...
          <p className="text-secondary-900 text-3xl md:text-4xl max-w-6xl my-8" data-aos="fade-in">
            I am creative Web developer based in Mumbai, India. I Have Done Bachelor of engineering
          ...
          <p className="text-secondary-900 text-3xl md:text-4xl max-w-6xl my-8" data-aos="fade-in">
            ...
            of my project is very quick and I always use GIT to track my progress and files, as well
          ...
          <Link href="https://drive.google.com/file/d/1SQBc9-Px8UvT6FeuOBZyCaugx4lPemx6/view?usp=drivesdk">
            <a
              ...
              className="rounded-lg border-2 px-4 py-2 md:px-8 md:py-4 mt-8 mb-24 border-info text-info dark:text-white dark:bg-darkblue dark:border-darkblue hover:bg-info hover:text-black"
              data-aos="fade-in"
              data-aos-delay={2000}
            >
              Get Resume
      ...
      <div className="flex flex-col items-center justify-center my-40">
        ...
        <main className="container">
          <h3 className="text-success dark:text-jaguar text-5xl md:text-4xl mb-14">

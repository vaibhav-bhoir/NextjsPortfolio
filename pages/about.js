            ...
            <div className="flex flex-col items-center justify-center mb-64 pt-20">
                ...
                <main className="container px-10 md:px-36 lg:px-56 mb-20">
                    ...
                    <Link href="https://drive.google.com/file/d/12oLbPyz9DUeocdihhhPYKaUlX-TMUtt0/view?usp=drivesdk">
                        <button className="flex items-center justify-center rounded-lg border-2  px-4 py-2 my-2 md:px-8 md:py-4 md:my-4 dark:text-white dark:bg-darkblue dark:border-darkblue  border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-black">

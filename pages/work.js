        ...
        <div className="min-h-screen px-3 overflow-hidden">
            ...
            <div className="min-h-screen flex flex-col items-center justify-center">
                <div className="h-1/4 mt-96 container relative w-full flex justify-center items-center">
                    ...
                    <h1 className=" hidden md:flex text-10xl text-secondary-100 dark:text-red-500 font-extrabold" >More Projects</h1>
                </div>
                <main className="container px-5 md:px-36 lg:px-56 flex flex-col items-center justify-center">

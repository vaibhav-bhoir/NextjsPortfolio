    ...
    <div className="px-3 overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center mt-64 md:mb-0">
        <main className="container px-10 md:px-36 lg:px-56 flex flex-row flex-wrap items-center justify-center">
          ...
          <h1
            className="text-secondary-100 dark:text-red-500 text-9xl md:text-7xl lg:text-8xl font-bold"
            data-aos="fade-in"
            data-aos-delay={500}
          >{name}</h1>
          <h1 className='text-secondary-900 text-4xl md:text-6xl'>
            <Typed
                  strings={subtitles}
                      typeSpeed={40}
                      backSpeed={60}
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <main className="container px-5 md:px-36 lg:px-56 flex flex-wrap flex-col items-center justify-center">
          ...
          {
            data.length !== 0 && <Link href="/work"><button className="rounded-lg border-2 px-8 py-4 my-4 border-success text-success self-center hover:bg-success hover:text-black">View More</button></Link>
          }
        </main>
      </div>

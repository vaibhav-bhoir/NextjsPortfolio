...
const ExCover = ({ data }) => {
    ...
    return (
        <div className="w-full border-1 mx-4 my-4 border-secondary-900 bg-frosted dark:bg-red-300 dark:border-red-500 rounded-xl px-4 transform transition-transform hover:scale-[1.02]">

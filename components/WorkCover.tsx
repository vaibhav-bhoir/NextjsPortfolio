...
const WorkCover = ({ data }: WorkProps) => {
    ...
    return (
        <div data-aos="fade-up" data-aos-duration="1000" className="w-full border-1 my-12 border-secondary-900 bg-frosted dark:bg-white dark:border-darkblue rounded-xl px-4 transform transition-transform hover:scale-[1.02]">

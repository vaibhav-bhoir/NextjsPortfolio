...
const ExCover = ({ expData }: ExCoverProps) => {
  return (
    <div
      data-aos="zoom-in-up"
      className="border-1 border-secondary-900 bg-frosted dark:bg-white dark:border-darkblue rounded-xl px-4 transform transition-transform hover:scale-[1.02]"
    >
      ...
      <hr />
      <h1 className="text-secondary-100 dark:text-darkblue text-4xl mx-4 my-6">
        {expData.fields.title}
      </h1>
      <h2 className="text-secondary-900 text-xl mx-4 flex items-center">
        <MdLocationPin />

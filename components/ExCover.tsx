...
const ExCover = ({ expData }: ExCoverProps) => {
    ...
    return (
        <div data-aos="zoom-in-up" className="w-full md:w-100 border-1 mx-4 my-4 border-secondary-900 bg-frosted dark:bg-white dark:border-darkblue rounded-xl px-4 transform transition-transform hover:scale-[1.02]">
